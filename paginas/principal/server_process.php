...
while ($aRow = $rResult->fetch_array(MYSQLI_NUM)) {
    ...
    // Botón Ver PDF del Contrato
    $row[] = "<a class='btn btn-sm' href='../reportes_pdf/generar_contrato_pdf.php?id_contrato={$id_registro}' target='_blank' title='Ver Contrato PDF'><i class='fa-solid fa-file-pdf text-info'></i></a>";
